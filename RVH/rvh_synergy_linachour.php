...
//กรณีมี Error เกิดขึ้น
    if ($mysqli->connect_error) {
        ...
        $get_data = $mysqli->query("SELECT date_pm, linac_hour_lt, linac_hour_ht FROM synergy_151792");
...
<html lang="en">
  <head>
    ...
    <title>Linac Hour | Synergy RVH</title>
                ...
                <?php
                    foreach($result as $result_tb){
                        echo"<tr>";
                            ...
                            echo "<td>".$result_tb['linac_hour_lt']."</td>";
                            echo "<td>".$result_tb['linac_hour_ht']."</td>";
                        echo"</tr>";
                    }
                ?>
