...
//กรณีมี Error เกิดขึ้น
    if ($mysqli->connect_error) {
        ...
        $get_data = $mysqli->query("SELECT date_pm, gantry_angle_zero, gantry_angle FROM synergy_151792");
...
<html lang="en">
  <head>
    ...
    <title>Gantry | Synergy RVH</title>
                ...
                <?php
                    foreach($result as $result_tb){
                        echo"<tr>";
                            ...
                            echo "<td>".$result_tb['gantry_angle_zero']."</td>";
                            echo "<td>".$result_tb['gantry_angle']."</td>";
                        echo"</tr>";
                    }
                ?>
