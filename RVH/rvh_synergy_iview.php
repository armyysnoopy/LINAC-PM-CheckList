...
//กรณีมี Error เกิดขึ้น
    if ($mysqli->connect_error) {
        ...
        $get_data = $mysqli->query("SELECT date_pm, iview_kv_flex_map, iview_image_scaling FROM synergy_151792");
    ...
    <h1>iView</h1>
        ...
        <table class="table" id="datatable">
            <thead>
                <tr>
                    <th></th>
                   <th>Imaging and Treatment coordinate coincidence</th> 
                   <th>Image Scalling (HorizMMPixel)</th> 
                </tr>
            </thead>
            <tbody>
                <?php
                    foreach($result as $result_tb){
                        echo"<tr>";
                            ...
                            echo "<td>".$result_tb['iview_kv_flex_map']."</td>";
                            echo "<td>".$result_tb['iview_image_scaling']."</td>";
                        echo"</tr>";
                    }
                ?>
