<?php
    session_start();  
    require_once("rvh_versahd_connectdb.php"); 
//null data sometime of pm checklist
...
$mysqli->close();
echo "<hr>";
echo "<a href='rvh_versahd_pm.php'>กลับไปหน้า PM Checklist</a>";
?>