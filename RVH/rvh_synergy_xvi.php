...
//กรณีมี Error เกิดขึ้น
    if ($mysqli->connect_error) {
        ...
        $get_data = $mysqli->query("SELECT date_pm, xvi_image_registration FROM synergy_151792");
    ...
    <h1>XVI</h1>
        ...
        <table class="table" id="datatable">
            <thead>
                <tr>
                    <th></th>
                   <th>Imaging and Treatment coordinate isocenter</th> 
                </tr>
            </thead>
            <tbody>
                <?php
                    foreach($result as $result_tb){
                        echo"<tr>";
                            ...
                            echo "<td>".$result_tb['xvi_image_registration']."</td>";
                        echo"</tr>";
                    }
                ?>
