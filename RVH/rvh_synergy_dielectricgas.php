...
//กรณีมี Error เกิดขึ้น
    if ($mysqli->connect_error) {
        ...
        $get_data = $mysqli->query("SELECT date_pm, pressure_sys_sf6 FROM synergy_151792");
...
<html lang="en">
  <head>
    ...
    <title>Dielectric Gas System | Synergy RVH</title>
                ...
                <?php
                    foreach($result as $result_tb){
                        echo"<tr>";
                            ...
                            echo "<td>".$result_tb['pressure_sys_sf6']."</td>";
                        echo"</tr>";
                    }
                ?>
